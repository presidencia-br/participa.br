...
<div>
    ...
    <form action="simple-search" method="get">
    	...
    	<!-- 
			Início: Formulário de busca Participa.br    		
    	 -->
    
    	<div class="layout-participa">
    	
		    <div class="row">
				<div style="padding-top: 40px; font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #00316f;padding-left: 0px;" class="col-md-12">
					BUSCA AVANÇADA
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12 fundo_com_hr">
					&nbsp;
				</div>
			</div>
			...
			<div class="row">
				...
				<div style="font-family: Arial, Helvetica, sans-serif; color: #9b9b9c; font-size: 12px; line-height: 150%; text-align: justify; " class="col-md-5">
					...
					<table style="border-collapse:separate; border-spacing:0 5px;">
						<tbody>
						<tr>
							<td style="padding-bottom: 10px;">Por:</td>
							<td width="70%">
								<input class="form-control" type="text" size="50" id="query" name="query" value="<%= (query==null ? "" : StringEscapeUtils.escapeHtml(query)) %>"/>
							</td>
						</tr>
						<tr>
							<td>
